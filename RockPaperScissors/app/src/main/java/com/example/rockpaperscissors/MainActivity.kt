...
class MainActivity : AppCompatActivity() {
    ...
    fun updateUI() {
        ...
        CoroutineScope(Dispatchers.Main).launch {
            ...
            withContext(Dispatchers.IO) {
                gameRepository.insertStat(stat)
            }
        }
        getStatistics()
    }
    private fun getStatistics() {
        ...
        mainScope.launch {
            ...
            val countDraw = gameRepository.getResultCount(getString(R.string.draw_string))
            var countLose = gameRepository.getResultCount(getString(R.string.lose_string))
            var countWin = gameRepository.getResultCount(getString(R.string.win_string))
